      ...
      <main className="max-w-md mx-auto p-4 pb-20">
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="gas">
            ...
            <AccordionContent>
              <p className="text-sm text-muted-foreground">
                No. When you send USDC, you sign an authorization and our facilitator service pays the gas fees on your behalf. 
          ...
          <AccordionItem value="offline">
            ...
            <AccordionContent>
              <p className="text-sm text-muted-foreground mb-2">
                Offline payments use pre-signed authorizations:
              </p>
              <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground ml-2">
                ...
                <li>Receiver submits it when they have internet</li>
              </ol>
              <p className="text-sm text-muted-foreground mt-2">
                The blockchain transaction happens when the receiver submits the authorization online.
              </p>
            </AccordionContent>
          </AccordionItem>
